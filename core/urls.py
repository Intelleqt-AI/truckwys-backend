...
from .views_admin import (
    ...
    AdminUserActivityView, AdminUserAuthHistoryView, AdminUserSessionsView, AdminUserSessionRevokeView,
...
urlpatterns = [
    ...
    path('admin/users/<int:user_id>/auth-history/', AdminUserAuthHistoryView.as_view(), name='admin-user-auth-history'),
    path('admin/users/<int:user_id>/sessions/', AdminUserSessionsView.as_view(), name='admin-user-sessions'),
    path('admin/users/<int:user_id>/sessions/<uuid:session_id>/', AdminUserSessionRevokeView.as_view(), name='admin-user-session-revoke'),
    path('admin/vehicle-types/', AdminVehicleTypesView.as_view(), name='admin-vehicle-types'),
    path('admin/vehicle-types/<int:type_id>/', AdminVehicleTypeDetailView.as_view(), name='admin-vehicle-type-detail'),
    path('admin/border-fees/', AdminBorderFeesView.as_view(), name='admin-border-fees'),
    path('admin/border-fees/<int:fee_id>/', AdminBorderFeeDetailView.as_view(), name='admin-border-fee-detail'),
    path('admin/transit-rates/', AdminCountryTransitRatesView.as_view(), name='admin-transit-rates'),
    path('admin/transit-rates/<int:rate_id>/', AdminCountryTransitRateDetailView.as_view(), name='admin-transit-rate-detail'),
